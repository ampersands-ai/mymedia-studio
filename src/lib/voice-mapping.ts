...
export const VOICE_DATABASE: VoiceData[] = [
  ...
  { voice_id: 'SAz9YHcvj6GT2YYXdXww', name: 'River', gender: 'neutral', accent: 'American', use_case: 'narration', description: 'Versatile and balanced voice', hasPreview: false },
  ...
  { voice_id: 'XB0fDUnXU5powFXDhCwa', name: 'Charlotte', gender: 'female', accent: 'British', use_case: 'narration', description: 'Elegant British female voice', hasPreview: true },
