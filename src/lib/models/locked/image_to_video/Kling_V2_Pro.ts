/** Kling V2 Pro (image_to_video) - Record: 84084ca4-4153-47d3-82db-c9e1d5f8a7b2 */
...
export const MODEL_CONFIG = { modelId: "kling/v2-1-pro", recordId: "84084ca4-4153-46bc-8d01-cd4e37d1da68", modelName: "Kling V2 Pro", provider: "kie_ai", contentType: "image_to_video",
  use_api_key: "KIE_AI_API_KEY_IMAGE_TO_VIDEO", baseCreditCost: 12, estimatedTimeSeconds: 300, costMultipliers: { duration: { "10": 2, "5": 1 } }, apiEndpoint: "/api/v1/jobs/createTask", payloadStructure: "wrapper", maxImages: 2, defaultOutputs: 1, 
  // UI metadata
  isActive: true,
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/image_to_video/Kling_V2_Pro.ts" } as const;
...
export function calculateCost(inputs: Record<string, any>) { const durKey = String(parseInt(inputs.duration || "5")) as keyof typeof MODEL_CONFIG.costMultipliers.duration; return MODEL_CONFIG.baseCreditCost * (MODEL_CONFIG.costMultipliers.duration[durKey] || 1); }
