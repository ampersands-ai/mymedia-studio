      ...
      <div className="flex flex-wrap gap-2 justify-center">
        {CREATION_GROUPS.map((group) => (
          <button
            ...
            className={cn(
              "p-2 md:p-3 rounded-xl transition-all duration-200 flex flex-col items-center gap-2 w-[140px] md:w-[160px] h-[100px] md:h-[110px] group",
          ...
          >
            ...
            <div className="flex flex-col items-center gap-0">
              <span className="font-semibold text-xs md:text-sm text-center">{group.label}</span>
              <span className="text-[10px] font-medium opacity-80 text-center whitespace-nowrap">
