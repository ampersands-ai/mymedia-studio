/** Kling V2.5 Turbo Pro (prompt_to_video) - Record: c5d9e1f3-6a7b-8c9d-0e1f-2a3b4c5d6e7f */
...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_video/Kling_V2_5_Turbo_Pro_T2V.ts",
} as const;
...
export function validate(inputs: Record<string, any>) {
  ...
  if (inputs.negative_prompt && inputs.negative_prompt.length > 2500) {
    return { valid: false, error: "Negative prompt must be 2500 characters or less" };
  }
  return { valid: true };
}
