/** Sora 2 Pro Text-to-Video (prompt_to_video) - Record: f8a2b3c4-9d0e-1f2a-3b4c-5d6e7f8a9b0c */
...
export const MODEL_CONFIG = {
  ...
  modelFamily: "Sora",
  variantName: "2 Pro Text-to-Video",
  displayOrderInFamily: 4,
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_video/Sora_2_Pro_T2V.ts",
} as const;
