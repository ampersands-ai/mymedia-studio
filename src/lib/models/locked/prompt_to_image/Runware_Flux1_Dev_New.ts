/**
 * Runware Flux.1 [Dev] (Text-to-Image)
 *
 ...
 * - FLUX architecture: Transformer-based, CFG-distilled
...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Runware_Flux1_Dev_New.ts",
} as const;
...
export const SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    CFGScale: {
      ...
      step: 0.5,
      showToUser: false,
      description: "How closely to follow the prompt. FLUX uses CFG-distilled approach.",
      isAdvanced: true,
    },
    outputQuality: {
      type: "integer",
