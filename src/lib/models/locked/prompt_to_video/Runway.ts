/** Runway (prompt_to_video) - Record: 7bde9fb9-b16b-47b0-86a7-c0762a1a58e3 */
...
export const MODEL_CONFIG = {
  ...
  costMultipliers: { duration: { "10": 2.5 }, quality: { "1080p": 2.5 } },
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_video/Runway.ts",
} as const;
...
export function preparePayload(inputs: Record<string, any>) {
  return { modelId: MODEL_CONFIG.modelId, input: { prompt: inputs.prompt, duration: inputs.duration || "5" } };
}
