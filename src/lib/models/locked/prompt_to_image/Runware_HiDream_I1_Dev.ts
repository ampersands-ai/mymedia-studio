/**
 * Runware HiDream-i1 Dev (Text-to-Image)
 *
 ...
 * - Dev version: balanced quality/speed (28 steps)
 *
 * @locked
 * @model runware:97@2
 * @provider runware
...
export const MODEL_CONFIG = {
  ...
  modelFamily: "HiDream",
  variantName: "HiDream-i1 Dev",
  displayOrderInFamily: 3,
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Runware_HiDream_I1_Dev.ts",
} as const;
