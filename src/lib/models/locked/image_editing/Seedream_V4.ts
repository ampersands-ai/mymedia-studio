...
export const MODEL_CONFIG = { modelId: "bytedance/v4-lite-image-to-image", recordId: "d2ffb834-fc59-4c80-bf48-c2cc25281fdd", modelName: "Seedream V4", provider: "kie_ai", contentType: "image", baseCreditCost: 0.35, estimatedTimeSeconds: 30, costMultipliers: { resolution: { "480p": 1, "720p": 2.5, "1080p": 5 } }, apiEndpoint: "/api/v1/jobs/createTask", payloadStructure: "wrapper", maxImages: 1, defaultOutputs: 1 } as const;
...
export function calculateCost(inputs: Record<string, any>) { return MODEL_CONFIG.baseCreditCost * (MODEL_CONFIG.costMultipliers.resolution[inputs.resolution || "480p"] || 1); }
