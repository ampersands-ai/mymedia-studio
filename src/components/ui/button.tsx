...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-secondary-500/20 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation",
  {
    variants: {
      variant: {
        default: "bg-primary-500 hover:bg-primary-600 active:bg-primary-700 text-neutral-900 dark:!text-neutral-900 font-semibold border-2 border-primary-600 shadow-lg shadow-primary-500/30 hover:shadow-xl hover:shadow-primary-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200",
        ...
        neon: "bg-primary-500 hover:bg-primary-600 text-neutral-900 dark:!text-neutral-900 font-bold border-2 border-primary-600 shadow-lg shadow-primary-500/30 hover:shadow-xl transition-all",
