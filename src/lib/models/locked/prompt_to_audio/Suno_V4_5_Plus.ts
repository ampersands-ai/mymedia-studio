...
export const MODEL_CONFIG = {
  ...
  modelFamily: "Suno",
  variantName: "V4.5+ (Richer Sound)",
  displayOrderInFamily: 3,
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_audio/Suno_V4_5_Plus.ts",
} as const;
