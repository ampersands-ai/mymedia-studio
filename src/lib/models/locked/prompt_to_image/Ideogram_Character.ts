...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Ideogram_Character.ts",
} as const;

export const SCHEMA = {
  properties: {
    aspect_ratio: { default: "1:1", enum: ["1:1", "3:4", "4:3", "9:16", "16:9"], type: "string" },
    magic_prompt_option: { default: "AUTO", enum: ["AUTO", "ON", "OFF"], type: "string" },
    prompt: { maxLength: 5000, renderer: "prompt", type: "string" },
    seed: { type: "integer" },
    style_type: { default: "DESIGN", enum: ["DESIGN", "REALISTIC", "ANIME"], type: "string" },
  },
  required: ["prompt"],
  type: "object",
} as const;
...
export function preparePayload(inputs: Record<string, any>) {
  return {
    ...
    input: {
      ...
      magic_prompt_option: inputs.magic_prompt_option || "AUTO",
      style_type: inputs.style_type || "DESIGN",
