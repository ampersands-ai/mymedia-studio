...
export const MODEL_CONFIG = { modelId: "V5", recordId: "a7c9e4f6-8d2b-5f3c-9a6e-7d4b8c5f3a9e", modelName: "Suno", provider: "kie_ai", contentType: "audio", baseCreditCost: 6, estimatedTimeSeconds: 180, costMultipliers: {}, apiEndpoint: "/api/v1/generate", payloadStructure: "flat", maxImages: 0, defaultOutputs: 1 } as const;
