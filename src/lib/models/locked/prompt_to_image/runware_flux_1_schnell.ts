...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/runware_flux_1_schnell.ts",
} as const;
...
export const SCHEMA = {
  ...
  properties: {
    ...
    aspectRatio: { type: "string", default: "3:4", enum: ["1:1", "16:9", "9:16", "4:3", "3:4"] },
...
export function preparePayload(inputs: Record<string, any>) {
  ...
  // Default to 3:4 (896x1152) to preserve original behavior
  let width = 896;
  let height = 1152;
