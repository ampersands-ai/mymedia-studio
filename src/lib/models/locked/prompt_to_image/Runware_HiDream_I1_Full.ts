/**
 * Runware HiDream-I1 Full (Text-to-Image)
 *
 ...
 * - HiDream architecture: Transformer-based diffusion with MoE backbone
 * - Full quality version (30 steps vs Fast's 16 steps)
 *
 * @locked
 * @model runware:97@1
 * @provider runware
...
export const MODEL_CONFIG = {
  ...
  modelFamily: "HiDream",
  variantName: "HiDream-I1 Full",
  displayOrderInFamily: 2,
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Runware_HiDream_I1_Full.ts",
} as const;
