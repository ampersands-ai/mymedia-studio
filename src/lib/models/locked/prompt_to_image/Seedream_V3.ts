...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Seedream_V3.ts",
} as const;
...
export const SCHEMA = {
  properties: {
    ...
    enable_safety_checker: { default: true, type: "boolean", showToUser: false },
    seed: { type: "integer", isAdvanced: true },
  },
  required: ["prompt"],
  type: "object",
} as const;
