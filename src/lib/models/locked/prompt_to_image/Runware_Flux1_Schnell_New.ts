/**
 * Runware Flux.1 [Schnell] (Text-to-Image)
 *
 ...
 * - FLUX Schnell: Distilled model for fast generation (4 steps)
...
export const MODEL_CONFIG = {
  ...
  modelFamily: "FLUX",
  variantName: "Flux 1 Schnell",
  displayOrderInFamily: 2,
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/prompt_to_image/Runware_Flux1_Schnell_New.ts",
} as const;
...
export const SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    steps: {
      ...
      maximum: 8,
      showToUser: false,
      description: "Number of inference steps. Schnell is optimized for 4 steps.",
      isAdvanced: true,
    },
    CFGScale: {
      type: "number",
...
export function validate(inputs: Record<string, unknown>): { valid: boolean; error?: string } {
  ...
  if (inputs.steps !== undefined) {
    ...
    if (steps < 1 || steps > 8) {
      return { valid: false, error: "Steps must be between 1 and 8 for Schnell" };
    }
  }
