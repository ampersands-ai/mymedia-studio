/**
 * 🔒 LOCKED MODEL: Ideogram Image Remix
 *
 * Group: image_editing
 * Provider: kie_ai
 * Content Type: image
...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/image_editing/Ideogram_Image_Remix.ts",
} as const;
...
export function validate(inputs: Record<string, any>): { valid: boolean; error?: string } {
  ...
  if (inputs.strength !== undefined && (inputs.strength < 0.01 || inputs.strength > 1)) {
    return { valid: false, error: "Strength must be between 0.01 and 1" };
  }
