...
export const MODEL_CONFIG = { modelId: "runware:102@1", recordId: "e8c4a9f2-6b7d-4e3a-9c1f-5d8b7a3e6f2c", modelName: "runware upscale", provider: "runware", contentType: "image", baseCreditCost: 0.25, estimatedTimeSeconds: 10, costMultipliers: {}, apiEndpoint: "https://api.runware.ai/v1", payloadStructure: "flat", maxImages: 1, defaultOutputs: 1 } as const;
