...
export const MODEL_CONFIG = { modelId: "bytedance/v1-pro-image-to-video", recordId: "e6d9a4f7-2c5b-8f3e-9a7d-4c8f5b6e3a9d", modelName: "Seedream V1 Pro", provider: "kie_ai", contentType: "video", baseCreditCost: 8, estimatedTimeSeconds: 300, costMultipliers: { duration: { 10: 3.33, 3: 1, 4: 1.33, 5: 1.66, 6: 2, 7: 2.33, 8: 2.66, 9: 3 } }, apiEndpoint: "/api/v1/jobs/createTask", payloadStructure: "wrapper", maxImages: 1, defaultOutputs: 1 } as const;
