...
export const CATEGORY_FILTERS = ['All', 'Abstract', 'Tech', 'Energetic', 'Minimal', 'Mesmerizing', 'Sunflowers', 'Solarpanel', 'Windfield', 'Ocean', 'Flags', 'Nautical', 'Nature', 'Wildlife', 'Physics', 'Magnetic'] as const;
