...
export const MODEL_CONFIG = {
  ...
  // Lock system
  isLocked: true,
  lockedFilePath: "src/lib/models/locked/image_to_video/WAN_2_2_Turbo.ts",
} as const;

export const SCHEMA = {
  properties: { image_url: { type: "string" }, prompt: { maxLength: 5000, type: "string" } },
...
export function preparePayload(inputs: Record<string, any>) {
  return { modelId: MODEL_CONFIG.modelId, input: { prompt: inputs.prompt, image_url: inputs.image_url } };
}
