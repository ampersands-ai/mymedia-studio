-- Update the email verification reward function to require all optional fields
...
BEGIN
  ...
  IF NEW.email_confirmed_at IS NOT NULL AND OLD.email_confirmed_at IS NULL THEN
    ...
    SELECT phone_number, country, zipcode, email_verified
    INTO user_profile
    ...
    IF user_profile.phone_number IS NOT NULL 
       ...
       AND user_profile.country IS NOT NULL 
       AND user_profile.country != ''
...
-- Create a function to check and award bonus when profile is completed
...
BEGIN
  -- Check if all optional fields are now filled
...
-- Create trigger for profile completion bonus
